    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-black/5 bg-white shadow-sm overflow-hidden">
        <div className="flex flex-col gap-4 border-b border-slate-50 p-6 md:flex-row md:items-center md:justify-between">
          <h3 className="text-lg font-bold text-slate-900">Fee Management</h3>
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-slate-50 text-sm">
              {isLoading ? (
                ...
                <tr><td colSpan={6} className="py-10 text-center text-slate-500">No vouchers generated yet.</td></tr>
              ) : (
                vouchers.map((v) => (
